	...
	<table id="bulletinTable">
		...
		<tr>
			<td id="write" style="height: 50px;" align="right" colspan="3"><a
				href="WriteBulletinController" style="text-decoration: none;">글쓰기&nbsp;&nbsp;&nbsp;</a>
			</td>
		</tr>
		<tr>
			<td colspan="3">
				<table id="bulletinTable2">
					<tr>
						<td class="bulletinTitle1" align="center">번호</td>
						<td class="bulletinTitle1" align="center">제목</td>
						<td class="bulletinTitle1" align="center">작성일</td>
						<td class="bulletinTitle1" align="center" colspan="2">사용자 권한</td>
					</tr>
					...
					<c:forEach var="b" items="${lists }">
						<tr>
							...
							<td class="bulletinButton" align="center">
								<button onclick="updateBulletin(${b.wn_no});">수정</button>
							</td>
							<td class="bulletinButton" align="center">
								<button onclick="deleteBulletin(${b.wn_no});">삭제</button>
							</td>
						</tr>
					</c:forEach>
				</table>
		...
		<tr>
			<td align="center">
				<c:if test="${curPageNo != 1 }">
					<a href="BulletinPageController?p=${curPageNo-1 }">◀ 이전</a>
				</c:if>
				<c:forEach var="p" begin="1" end="${pageCount }">
					<a href="BulletinPageController?p=${p }"> ${p }</a>
				</c:forEach>
				<c:if test="${curPageNo != pageCount }">
					<a href="BulletinPageController?p=${curPageNo+1 }">다음 ▶</a>
				</c:if>
			</td>
		</tr>
	</table>
